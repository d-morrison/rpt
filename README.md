...
| [`coatless-quarto/custom-callout`](https://github.com/coatless-quarto/custom-callout) | Distinct colors per theorem/callout type, driven by the `custom-callout:` YAML block |
| [`d-morrison/revealjs-html-links`](https://github.com/d-morrison/revealjs-html-links) | Adds a link back to the standalone HTML page on every RevealJS slide deck |
