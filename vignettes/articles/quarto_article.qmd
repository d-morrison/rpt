...
The **standard error** of the mean for a sample of size $n$ with standard deviation $s$ is:
...
Let $X_1, X_2, \ldots, X_n$ be independent and identically distributed random variables with mean $\mu$ and finite variance $\sigma^2$. Then as $n \to \infty$:

$$\frac{\bar{X} - \mu}{\sigma / \sqrt{n}} \xrightarrow{d} N(0, 1)$$
:::

::: {.proof}
See any standard probability textbook.
:::
...
By @thm-clt and @def-se, an approximate 95% confidence interval for $\mu$ is:
...
For the sample below, we calculate a 95% confidence interval for the mean:
...
::: {#exr-se}
## Exercise: Computing Standard Error

Compute the standard error for a sample of size $n = 100$ with sample standard deviation $s = 15$.
:::
